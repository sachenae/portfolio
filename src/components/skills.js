    ...
    return(
        <section id='skills'>
            ...
            <div className="container">
                ...
                <div className="col s6 push-l6 skillsText"><strong>Javascript</strong> and <strong>Java Programming</strong> are essential developer skills</div>  
                ...
                <div className="col s12 l6 skills">
                    ...
                    <div className="col s6 skillsText">Experience with <strong>CRUD</strong> operations using industry standard <strong>MySQL</strong> and the emerging <strong>Node.js</strong> with <strong>MongoDB</strong></div>
                </div>
