...
import LogoImg from '../assets/images/landing/name.png';
        ...
        if(isMobile){
            navbar = (
                <nav>
                    ...
                    <a className='nav-text-name center brand-logo'href="#landing_page">{<div> <img src = {LogoImg} width= '100px' alt=''/></div>}</a>
            ...
            navbar = (
                <nav>
                    ...
                    <a className='nav-text-name' href="#landing_page">{<img src = {LogoImg} width= '100px' alt=''/>}</a>
